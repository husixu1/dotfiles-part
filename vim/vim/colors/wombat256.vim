...
" TODO complete gui colors
hi ALEErrorSign         ctermfg=9   ctermbg=0       cterm=bold          guifg=#ff0000   guibg=#303030   gui=bold
hi ALEWarningSign       ctermfg=192 ctermbg=0       cterm=bold
hi ALEInfoSign          ctermfg=33  ctermbg=0       cterm=bold
hi ALEStyleErrorSign    ctermfg=9   ctermbg=0       cterm=none
hi ALEStyleWarningSign  ctermfg=192 ctermbg=0       cterm=none
